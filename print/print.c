...
static void user_print_ascii_art() {
    ...
    print_color(text_colors[0], BLACK, "██╗");    print_color(LIGHT_PURPLE,BLACK, " ▝▜██╗ ");    print_color(text_colors[1], BLACK, "██╗ ");    print_color(text_colors[2], BLACK, "██╗    ██╗ ");    print_color(text_colors[3], BLACK, " ██████╗  ");    print_color(text_colors[4], BLACK, " ██████╗  ");    print_color(text_colors[5], BLACK, "███╗   ███╗ ");    print_color(text_colors[6], BLACK, "███████╗\n");
    print_color(text_colors[0], BLACK, "██║");    print_color(LIGHT_PURPLE,BLACK, " ▐█▌▝╝ ");    print_color(text_colors[1], BLACK, "██║ ");    print_color(text_colors[2], BLACK, "██║    ██║ ");    print_color(text_colors[3], BLACK, "██╔═══██╗ ");    print_color(text_colors[4], BLACK, "██╔═══██╗ ");    print_color(text_colors[5], BLACK, "████╗ ████║ ");    print_color(text_colors[6], BLACK, "██╔════╝\n");
    print_color(text_colors[0], BLACK, "███");    print_color(LIGHT_PURPLE,BLACK, "██╔╝   ");    print_color(text_colors[1], BLACK, "██║ ");    print_color(text_colors[2], BLACK, "██║ █╗ ██║ ");    print_color(text_colors[3], BLACK, "██║   ██║ ");    print_color(text_colors[4], BLACK, "██║   ██║ ");    print_color(text_colors[5], BLACK, "██╔████╔██║ ");    print_color(text_colors[6], BLACK, "█████╗  \n");
    print_color(text_colors[0], BLACK, "██╔═██╗   ");                                                                 print_color(text_colors[1], BLACK, "██║ ");    print_color(text_colors[2], BLACK, "██║███╗██║ ");    print_color(text_colors[3], BLACK, "██║   ██║ ");    print_color(text_colors[4], BLACK, "██║   ██║ ");    print_color(text_colors[5], BLACK, "██║╚██╔╝██║ ");    print_color(text_colors[6], BLACK, "██╔══╝  \n");
    print_color(text_colors[0], BLACK, "██║   ██╗ ");                                                                 print_color(text_colors[1], BLACK, "██║ ");    print_color(text_colors[2], BLACK, "╚███╔███╔╝ ");    print_color(text_colors[3], BLACK, "╚██████╔╝ ");    print_color(text_colors[4], BLACK, "╚██████╔╝ ");    print_color(text_colors[5], BLACK, "██║ ╚═╝ ██║ ");    print_color(text_colors[6], BLACK, "███████╗\n");
    print_color(text_colors[0], BLACK, "╚═╝   ╚═╝ ");                                                                 print_color(text_colors[1], BLACK, "╚═╝ ");    print_color(text_colors[2], BLACK, " ╚══╝╚══╝  ");    print_color(text_colors[3], BLACK, " ╚═════╝  ");    print_color(text_colors[4], BLACK, " ╚═════╝  ");    print_color(text_colors[5], BLACK, "╚═╝     ╚═╝ ");    print_color(text_colors[6], BLACK, "╚══════╝\n\n");
}
